...
class TheoryTestCertificate extends \TheoryTest\Car\TheoryTestCertificate
{
    ...
    public function generateCertificate()
    {
        ...
        if ($this->theory->testresults['status'] == 'pass') {
            ...
            $this->pdf->Cell(10, 14, '', 0);
            $this->pdf->Cell(28, 14, 'Candidate', 0);
            $this->pdf->Ln(12);
        ...
        if ($this->theory->testresults['status'] == 'pass') {
            $this->pdf->Cell(184, 10, "Congratulations ".$this->certUsername);
            $this->pdf->Ln(4);
            ...
            $this->pdf->Cell(184, 10, "Sorry ".$this->certUsername.", but you have not passed this time.");
            $this->pdf->Ln(4);
    ...
    protected function overallResults()
    {
        ...
        foreach ($this->theory->getCategories() as $group => $data) {
            ...
            if ($correct >= $this->theory->passmarkPerCat) {
                $groupstatus = 'Passed';
            } else {
                $groupstatus = 'Failed';
            }
